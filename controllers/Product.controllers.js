...
productController.getAllProducts=async (req,res)=>{
    try{
        ...
        .populate("createdBy","username email") // get creator info
        .skip((page-1)*limit)
        .limit(Number(limit));
...
// PATCH /products/:id  // Update product info  // Admin-only
...
productController.updateProduct=async (req,res)=>{
    ...
    const isvalidateupdate=updatekeys.every(field=>allowfields.includes(field));
